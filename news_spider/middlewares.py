...
import os
import logging
import preprocess.fetch_free_proxyes
import random
...
class RandomUserAgent(object):
    ...
    def process_request(self,request,spider):
        ...
        one_user_agent = random.choice(self.agents)

        if one_user_agent:
            #print one_user_agent
            request.headers.setdefault('User-Agent',one_user_agent)
...
class HttpProxyMiddleware(object):
    ...
    def __init__(self, settings):
        ...
        self.proxy_file = "./mysetting/proxyes.data"
        # 是否在超时的情况下禁用代理
